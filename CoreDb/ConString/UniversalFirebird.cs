...
namespace CoreDb
{
    ...
    public class FirebirdUniversalConnectionStringBuilder : UniversalConnectionStringBuilder
    {
        public FirebirdUniversalConnectionStringBuilder()
        {
        }

        public FirebirdUniversalConnectionStringBuilder(string connectionString)
        {
        }
    }
    ...
    public class FirebirdUniversalConnectionStringBuilder : UniversalConnectionStringBuilder
    {
        protected new FirebirdSql.Data.FirebirdClient.FbConnectionStringBuilder m_ConnectionStringBuilder;
        ...
        public FirebirdUniversalConnectionStringBuilder(string connectionString)
        {
            this.m_ConnectionStringBuilder = new FirebirdSql.Data.FirebirdClient.FbConnectionStringBuilder(connectionString);
        }
